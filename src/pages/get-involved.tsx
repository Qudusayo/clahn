...
const GetInvolved = () => {
	return (
		<Layout>
			<Hero
				heroImg={GetInvolvedHeroImg.src}
			...
			<div className="bg-[#F6F6F6] pb-20 pt-16">
				...
				<div className="mx-auto mt-12 grid w-[90%] max-w-5xl grid-cols-6 gap-y-10">
					<div className="col-span-3 space-y-4 break-words text-sm font-semibold md:col-span-2 md:text-base">
						<FooterIcon Icon={<Icons.Message className="w-4/5" />} />
						<p>Say Hi!</p>
						<p>info@clahninitiative.org</p>
					</div>
					<div className="col-span-3 space-y-4 text-sm font-semibold md:col-span-2 md:text-base">
						<FooterIcon Icon={<Icons.Call className="w-full" />} />
						<p>Let&apos;s Talk</p>
						<p> +234 817 7477 995</p>
					</div>
					<div className="col-span-full space-y-4 text-sm font-semibold md:col-span-2 md:text-base">
...
const FooterIcon = ({ Icon }: { Icon: React.ReactElement }) => {
	return (
		<div className="flex h-12 w-12 items-center justify-center rounded-full border border-[#5e5e5e4d] bg-white">
			{Icon}
		</div>
	);
};
