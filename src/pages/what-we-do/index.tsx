...
const BlockContent = ({
	...
	return (
		<div className="flex flex-col gap-6 lg:flex-row">
			<div className="box-border flex h-28 w-28 items-center justify-center rounded-full border-[6px] border-[#F0F0F0] bg-white p-4 lg:h-48 lg:w-48">
	...
	return (
		<div className="flex w-full flex-col items-center gap-5 rounded-3xl bg-white md:flex-row md:gap-10 md:pr-8">
			...
			<div className="space-y-4 px-4 pb-8 md:px-0 md:pb-0">
				<h2 className="text-xl font-semibold text-[#1B1717]">
					{project.title}
				</h2>
