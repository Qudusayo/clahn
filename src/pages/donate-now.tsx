	...
	return (
		<Layout>
			...
			<section className="bg-white py-10 pb-16">
				<h1 className="text-balance py-3 text-center text-2xl font-semibold text-[#1B1717] md:mb-20 md:py-10 md:text-4xl">
					Kindly Choose a Method of Donation
				</h1>
				<section className="relative my-10 bg-[#EBF4F2] py-10 md:my-14 md:py-20">
					<div className="absolute -top-7 left-14 flex h-14 w-14 -translate-x-1/2 transform items-center justify-center rounded-full border-t bg-white md:-top-14 md:left-1/2 md:h-28 md:w-28">
						<DonateIcon className="mx-auto h-10 w-10 md:h-20 md:w-20" />
					</div>
					<MaxComponent className="space-y-4">
						<h1 className="py-2 text-2xl font-semibold text-[#038748] md:py-4 md:text-center md:text-4xl">
							Contribute through Paystack.
						</h1>
						<p className="mx-auto max-w-screen-lg text-sm text-[#1B1717] md:text-center md:text-lg">
				...
				<section className="py-10 md:py-20">
					<MaxComponent className="grid grid-cols-1 gap-10 bg-contain lg:grid-cols-2 lg:gap-24">
						<div className="mx-auto flex w-full flex-col items-start gap-5 border-l-8 border-[#FEE55D] bg-white p-4 py-8 shadow-card md:gap-10 md:p-8">
							<div>
								<h2 className="text-xl font-bold text-[#1B1717] md:text-3xl">
									Donate in Naira
								</h2>
						...
						<div className="mx-auto flex w-full flex-col items-start gap-5 border-l-8 border-[#F0B99F] bg-white p-4 py-8 shadow-card md:gap-10 md:p-8">
							<div>
								<h2 className="text-xl font-bold text-[#1B1717] md:text-3xl">
									US Dollar Donation
								</h2>
...
const BankDetail = ({
	...
	return (
		<div className="text-[#1B1717]">
			...
			{allowCopy && (
				<Copy
					className="ml-2 inline-block h-4 w-4 cursor-pointer transition-transform active:scale-110 active:transform"
